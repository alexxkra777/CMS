...
///////////////////////////////////////////////////////////////////////////////////	
	...
	$check = "SELECT email, password FROM admin_libus WHERE email = :check_email AND password = :check_password LIMIT 0,1";

	$sql_command = $db->prepare($check);
	$sql_command->execute($array);
		
	$data_pass_and_email = $sql_command->fetchAll(PDO::FETCH_ASSOC);

	$finish_check = count($data_pass_and_email);
